...
const NonMemoizedMarkdown: FC<{
  ...
  if (!isAssistant) {
    return (
      <div className="prose dark:prose-invert prose-p:leading-relaxed prose-pre:p-0 bg-secondary min-w-full max-w-[80vw] space-y-6 break-words rounded-3xl px-5 py-2.5 md:w-full">
