...
export const MessageMarkdown: FC<MessageMarkdownProps> = ({
  ...
  if (!isAssistant) {
    return (
      <div className="prose dark:prose-invert prose-p:leading-relaxed prose-pre:p-0 bg-secondary max-w-[80vw] min-w-full space-y-6 break-words md:w-full rounded border p-2">
